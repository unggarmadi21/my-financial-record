...
<head>
    <meta charset="UTF-8">
    <meta name="dicoding:email" content="unggarmadi@gmail.com">
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top main-nav" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#page-top">My Financial Record</a>
    ...
    <header id="home" class="text-light parallax">
        <div class="container konten">
            <h1 style="font-size: 36pt;">Welcome to My Financial - Record</h1>
    ...
    <section id="features" class="bg-light">
        <div class=" container konten2">
            ...
            <div class="col-lg-12 foot-fitur">
                <h4 class="headline text-center">My Financial - Record</h4>
                <p class="isi-fitur text-center">My Financial - Record adalah aplikasi web pencatatan keuangan harian yang
                ...
                <div class="col-lg-4">
                    <div class="team">
                        ...
                        <div class="teks">
                            ...
                            <p>CEO My Financial Record</p>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam dolorem nostrum quas! Debitis quos optio sapiente quisquam temporibus unde accusamus sed eius vel, culpa corrupti eos repellat repellendus quam voluptatum!</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="team">
                        ...
                        <div class="teks">
                            ...
                            <p>Team Design My Financial Record</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est, consequatur incidunt sapiente, accusantium voluptas error molestiae voluptates quidem commodi cumque omnis, tempore dolore suscipit mollitia! Perspiciatis adipisci ea quos alias?</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="team">
                        ...
                        <div class="teks">
                            ...
                            <p>Team IT My Financial Record</p>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. A assumenda debitis quisquam ea? Eum vel voluptatibus temporibus excepturi, cupiditate ipsum. Impedit voluptate commodi, aspernatur ut minima adipisci voluptatum laborum omnis?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container text-light">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 p-3">
                    <h5> <b>About</b> </h5>
                    <p class="mb-0">Aplikasi My Financial Record dilengkapi dengan fitur menarik yang dapat mempermudah user mengelola keuangannya.</p>
                </div>
                <div class="col-lg-3 col-md-6 p-3">
                    <h5> <b>Follow us</b> </h5>
                    <div class="row">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="mb-0 mt-2">Copyright © 2024 My Financial Record. All rights reserved</p>
                </div>
            </div>
        </div>
    </div>
