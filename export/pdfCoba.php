...
<page backtop="14mm" backbottom="14mm" backleft="1mm" backright="10mm">
    ...
    <table class="page_header">
        <tr>
            <td style="text-align: left;    width: 10%">My Financial - Record</td>
...
<table>
    ...
    <td align="center" style="width: 800px;"><font style="font-size: 18px"><br><b>Laporan Pencatatan Keuangan Harian</b></font>
        <br><br>Monitoring keuangan harian anda dengan my financial - record untuk mempermudah pengelolaan keuangan anda 
