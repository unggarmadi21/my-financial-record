...
<head>
    ...
    <title>My Financial Record - Pengeluaran</title>
...
<body>
    <div class="header">
        ...
        <h3 class="text-secondary font-weight-bold float-left logo">My Financial</h3>
        <h3 class="text-secondary float-left logo2">- Record</h3>
